...
image_path = os.path.join(os.getcwd(), "static", "header-heart-prediction.png")
...
st.set_page_config(
    ...
    menu_items={
        'Get Help': 'https://github.com/marcusRB/uoc_ds_tfg_2024/README.md',
        'Report a bug': "https://www.github.com/marcusRB/uoc_ds_tfg_2024/issues",
        'About': f"### {title}.\nThis is an exerimental app and not intended for real world use. \
                Original source based on github.com/bsenst"
    }
)
...
with cent_co:
    st.image(image_path, width=500,
         caption="Image generated by Bing Copilot")
